...
int MetricsServer::m_worldCountChannel = 1;
std::string MetricsServer::m_worldCountChannelDescription;
bool MetricsServer::m_done = true;
...
void MetricsServer::install()
{
	...
	ms_taskConnection = new TaskConnection("192.168.1.130", ConfigMetricsServer::getTaskManagerPort());
