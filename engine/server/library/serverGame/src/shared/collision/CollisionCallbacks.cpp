...
{
        DEBUG_WARNING(!object, ("CollisionCallbacksNamespace::onDoCollisionWithTerrain: Object == nullptr"));
        DEBUG_WARNING(!wasHitByThisObject, ("CollisionCallbacksNamespace::onDoCollisionWithTerrain: wasHitByThisObject == nullptr"));
